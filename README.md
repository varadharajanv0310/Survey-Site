...
Ingestion is a separate service from the frontend on purpose: the postback URL
is what we hand to networks, and it should not go down because the web app is
deploying.
